...
public enum ErrorCode {
    ...
    NO_PARSED_DOCUMENT(HttpStatus.BAD_REQUEST,
            "만들 근거가 없습니다. 강의자료를 올리거나, 시험 범위를 입력해 주세요."),
    ...
    CHAT_NOT_READY(HttpStatus.CONFLICT, "학습 내용을 먼저 만들어 주세요. 아직 답할 근거가 없습니다."),
    CHAT_FAILED(HttpStatus.BAD_GATEWAY, "답변을 만들지 못했습니다. 다시 시도해 주세요."),
