-- 학습자료 기반 학습 챗봇 (2026-08-28)
--
-- 운영 프로파일은 ddl-auto=validate 다. 엔티티를 더해도 테이블이 자동으로 생기지 않고,
-- 적용하지 않으면 애플리케이션이 기동 중 Schema-validation 으로 죽는다.
-- 새 버전을 배포하기 **전에** 먼저 적용한다.
--
--   psql -h <endpoint> -U <user> -d naeil_study -f docs/migrations/002-study-chat.sql
--
